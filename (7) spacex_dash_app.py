...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        # return the outcomes piechart for a selected site
            ...
            fig=px.pie(filtered_df, names = 'class', title='Total Individual Launch Site')
            return fig
...
def get_scatter_chart(entered_site, payload):
    ...
    if entered_site == 'ALL':
        ...
        # return the outcomes piechart for a selected site
            ...
            filtered_df = filtered_df[filtered_df['Launch Site'] == entered_site]
            fig = px.scatter(filtered_df, x='Payload Mass (kg)', y='class', color='Booster Version Category', title='Count At Site')
            return fig
